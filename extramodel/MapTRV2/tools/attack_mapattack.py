    ...
    if hasattr(cfg, 'plugin'):
        if cfg.plugin:
            ...
            if hasattr(cfg, 'plugin_dir'):
                ...
                if cfg.model.get('type', None) == 'MapTRv2':
                    importlib.import_module('projects.mmdet3d_plugin.maptr.detectors.maptrv2')
                    importlib.import_module('projects.mmdet3d_plugin.maptr.dense_heads.maptrv2_head')
            else:
