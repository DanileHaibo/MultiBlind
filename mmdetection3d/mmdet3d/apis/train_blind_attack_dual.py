...
def single_gpu_attack_camera_blind_dual(
    ...
    for i, data in enumerate(data_loader):
        ...
        if cfg.attack.loss == 'rsa':
            ...
            with open(
                f'{dataset_dir}/diverge_route_centerlines_{cfg.attack.dataset}/{sample_token}.json',
                'r',
            ) as f:
        ...
        # ----- Phase 1: identical to single blind — best single flare location -----
        print(
            f'\n[Dual phase 1] Single-flare search (same as blind): '
